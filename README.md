...
* Artifacts.use() - [transformDirectory](transformDirectory), [listenToArtifacts](listenToArtifacts), [transformManifest](transformManifest), [createSingleArtifact](createSingleArtifact), [appendToMultipleArtifact](appendToMultipleArtifact), [workerEnabledTransformation](workerEnabledTransformation)
